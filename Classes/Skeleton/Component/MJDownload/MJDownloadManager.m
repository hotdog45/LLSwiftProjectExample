...
/** 根文件夹 */
static NSString * const MJDownloadRootDir = @"com.yt.kdtk";

/** 默认manager的标识 */
static NSString * const MJDowndloadManagerDefaultIdentifier = @"com.yt.kdtk";
...
- (NSString *)filename
{
    if (_filename == nil) {
        ...
        if (pathExtension.length) {
            _filename = [NSString stringWithFormat:@"%@.%@.mp4", self.url.MD5, pathExtension];
        } else {
